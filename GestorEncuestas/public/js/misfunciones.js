...
function anadirdivpreguntas(cont_apartados){
	...
	$('#menupreguntas_A' + cont_apartados ).prepend('<li class="pasos"><a href="#step-' + contPreguntas + '"><span class="step_no">' + contPreguntas + '</span><span class="step_descr"></span></a></li>');
    
    nuevamodal = generapregunta(cont_apartados);
    $('#nuevosapartados_A'  + cont_apartados ).append(nuevamodal);
...
function generaHTMLmodal(cont_apartados){
    ...
    /*contenido = '<div id="wizard' +  cont_apartados  + '" class="form_wizard wizard_horizontal">';   
    ...
    contenido +=        '<div id="nuevosapartados_A' + cont_apartados + '">';           
    contenido +=            '<div id="step-0_A' + cont_apartados + '"></div>';

    generapregunta(cont_apartados);
...
function generapregunta(cont_apartados){
    ...
    contenido =            '<div id="step-1_A' + cont_apartados + '">';
                            
    contenido +=            '</br>';
    contenido +=                '<div class="col-md-6 col-xs-12">';
    contenido +=                '<div class="x_panel" style="background-color:#A9F5BC;color:#524c57;">';
    contenido +=                    '<div class="x_title">';
    contenido +=                    '<h2>Pregunta ' + cont_apartados + '</h2>';
    contenido +=                    '<div class="clearfix"></div>';
    contenido +=                    '</div>';

    contenido +=                    '<div class="x_content">';
